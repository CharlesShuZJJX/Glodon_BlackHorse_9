...
int easyexif::ExifFunctions::cmdShowEXIF(easyexif::EXIFInfo& result)
{
...
void easyexif::ExifFunctions::getFocus(easyexif::EXIFInfo& result, double& focal, double& focal35mm)
{
    focal = result.FocalLength;
    focal35mm = result.FocalLengthIn35mm;
}
double easyexif::ExifFunctions::getRcmos(double focal, double focal35mm)
{
    return 43.2 * focal35mm / focal;
}
